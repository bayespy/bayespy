...
import bayespy.nodes.variable
import bayespy.nodes.gamma
import bayespy.nodes.gaussian
import bayespy.nodes.normal
import bayespy.nodes.dot
imp.reload(utils)
...
imp.reload(bayespy.nodes.variable)
imp.reload(bayespy.nodes.gamma)
imp.reload(bayespy.nodes.gaussian)
imp.reload(bayespy.nodes.normal)
imp.reload(bayespy.nodes.dot)
...
def run(M=10, N=100, D_y=3, D=5):
    ...
    # Inference loop.
    Q.update(X, W, tau, alpha, repeat=100)
